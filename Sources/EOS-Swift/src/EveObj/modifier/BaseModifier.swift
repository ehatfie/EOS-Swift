...
protocol BaseModifierProtocol {
  ...
  func valdiateAffecteeFilterDomainSkillRequirement() -> Bool
...
extension BaseModifierProtocol {
  ...
  func validateBase() -> Bool {
    ...
    case .domain_skillrq: validationResult = self.valdiateAffecteeFilterDomainSkillRequirement()
  ...
  func validateCommon() -> Bool {
    let validModAffecteeFilter = ModAffecteeFilter.allCases.contains(self.affecteeFilter)
  ...
  func validateAffecteeFilterOwnerSkillRequirements() -> Bool {
